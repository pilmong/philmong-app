...
import { parseNaverOrderText } from './src/lib/naver-parser';
...
console.log(JSON.stringify(parseNaverOrderText(trickyText), null, 2));
...
console.log(JSON.stringify(parseNaverOrderText(oneLineText), null, 2));
