...
export function DialogContent({ children, className }: { children: React.ReactNode; className?: string }) {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            />
            <div className={cn(
                "relative z-[101] w-full max-w-lg rounded-2xl bg-white dark:bg-slate-900 opacity-100 border-2 border-slate-200 dark:border-slate-800 shadow-[0_20px_50px_rgba(0,0,0,0.3)] animate-in fade-in zoom-in-95 duration-200 overflow-hidden",
                className
            )}>
                <div className="p-6">
                    {children}
